...
<body>
    ...
    <form action="{{route('characters.store')}}" method="POST">
        ...
        <select name="hsk_level" id="hsk_level" required>
       ...
       <fieldset>
        ...
        <textarea name="example_hanji" id="example_hanji"></textarea>

        <label for="example_pinyin">Пиньинь примера</label>
        <textarea name="example_pinyin" id="example_pinyin"></textarea>

        <label for="example_translation">Перевод примера</label>
        <textarea name="example_translation" id="example_translation"></textarea>
