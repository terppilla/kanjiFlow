        ...
        <form action="{{ route('admin.characters.store') }}" method="POST" class="character-form">
            ...
            <div class="form-group">
                ...
                <select name="hsk_level" id="hsk_level" class="form-control" required>
                    ...
                    <option value="1" {{ old('hsk_level') == 1 ? 'selected' : '' }}>HSK 1</option>
                    <option value="2" {{ old('hsk_level') == 2 ? 'selected' : '' }}>HSK 2</option>
                    <option value="3" {{ old('hsk_level') == 3 ? 'selected' : '' }}>HSK 3</option>
                    <option value="4" {{ old('hsk_level') == 4 ? 'selected' : '' }}>HSK 4</option>
                    <option value="5" {{ old('hsk_level') == 5 ? 'selected' : '' }}>HSK 5</option>
                    <option value="6" {{ old('hsk_level') == 6 ? 'selected' : '' }}>HSK 6</option>
                </select>
            </div>
            ...
            <div class="form-group">
                <fieldset>
                    ...
                    <div class="fieldset-group">
                        ...
                        <textarea name="example_hanzi" id="example_hanzi" class="form-control">{{ old('example_hanzi') }}</textarea>
                    </div>

                    <div class="fieldset-group">
                        <label for="example_pinyin" class="optional">Пиньинь примера</label>
                        <textarea name="example_pinyin" id="example_pinyin" class="form-control">{{ old('example_pinyin') }}</textarea>
                    </div>

                    <div class="fieldset-group">
                        <label for="example_translation" class="optional">Перевод примера</label>
                        <textarea name="example_translation" id="example_translation" class="form-control">{{ old('example_translation') }}</textarea>
                    </div>
