            ...
            <div class="collections-form-card">
                ...
                <form action="<?php echo e(route('collections.store')); ?>" method="post">
                    ...
                    <div class="collections-field">
                        ...
                        <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required maxlength="120" placeholder="Например: Глаголы на неделю">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="collections-form-actions">
                        ...
                        <a href="<?php echo e(route('collections.index')); ?>" class="btn btn-ghost">Отмена</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /home/c/cy906984/kanjilflow_public/public_html/resources/views/user/collections/create.blade.php ENDPATH**/ ?>