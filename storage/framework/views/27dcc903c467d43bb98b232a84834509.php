...
<div class="hero">
        ...
        <div class="hero-text">
            ...
            <div class="hero-buttons">
              <a href="<?php echo e(route('register')); ?>" class="btn btn--gold-filled">Начать обучение</a>
              <a href="<?php echo e(route('login')); ?>" class="btn btn-primary">У меня уже есть аккаунт</a>
            </div>
        </div>
</div>
</header>
...
<section class="sta">
    ...
    <div class="cta-buttons">
        <a href="<?php echo e(route('register')); ?>" class="btn btn--primary">Начать обучение</a>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-filled">У меня уже есть аккаунт</a>
    </div>
</section>
</main>
...
<footer class="landing-footer">
    <div class="landing-footer-inner">
        <p class="landing-footer-copy">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'KanjiFlow')); ?>. Все права защищены.</p>
    </div>
</footer>
...
<?php endif; ?>
<?php /**PATH /home/c/cy906984/kanjilflow_public/public_html/resources/views/welcome.blade.php ENDPATH**/ ?>