...
<?php $component->withAttributes([]); ?>
    <div class="form-container admin-article-form-page">
        ...
        <form action="<?php echo e(route('admin.builtin-collections.store')); ?>" method="POST" class="character-form">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('slug')); ?>" required placeholder="например everyday">
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php echo $__env->make('admin.builtin_collections._glyph_picker', ['initialCharacters' => []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo e(route('admin.builtin-collections.index')); ?>" class="btn-cancel">Отмена</a>
            </div>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/c/cy906984/kanjilflow_public/public_html/resources/views/admin/builtin_collections/create.blade.php ENDPATH**/ ?>