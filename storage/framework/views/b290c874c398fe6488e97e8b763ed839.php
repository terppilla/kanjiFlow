...
<?php $component->withAttributes([]); ?>
    ...
    <div class="articles-page page-learning-select-level">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="back-link">← Назад в дашборд</a>
        ...
        <div class="hsk-levels-grid">
            <?php for($level = 1; $level <= 6; $level++): ?>
                ...
                <a href="<?php echo e(route('learning.level', $level)); ?>" class="hsk-card">
                    <div class="hsk-card-header">
                        <div class="hsk-title">HSK <?php echo e($level); ?></div>
                        <div class="hsk-count"><?php echo e($stats['learned']); ?>/<?php echo e($stats['total']); ?></div>
                    </div>
                    ...
                    <div class="progress-container">
                        <div class="progress-header">
                            ...
                            <span class="progress-percent"><?php echo e($progress); ?>%</span>
                        </div>
                    ...
                    <div class="hsk-stats">
                        ...
                        <div class="stat">
                            <span class="stat-value"><?php echo e($stats['learned']); ?></span>
                            <span class="stat-label">Выучено</span>
                        </div>
                        <div class="stat">
                            <span class="stat-value"><?php echo e($stats['total'] - $stats['learned']); ?></span>
        ...
        <section class="select-level-collections" aria-labelledby="select-level-collections-heading">
            ...
            <div class="select-level-collections-grid">
                <?php $__empty_1 = true; $__currentLoopData = $builtinCollections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    ?>
                    <a href="<?php echo e(route('learning.collection.level', $collection)); ?>" class="hsk-card">
                        <div class="hsk-card-header">
                            <div class="hsk-title"><?php echo e($collection->name); ?></div>
                            <div class="hsk-count"><?php echo e($cLearned); ?>/<?php echo e($cTotal); ?></div>
                        </div>

                        <div class="hsk-description">
                            Тематическая подборка из <?php echo e($cTotal); ?> иероглифов. Можно проходить параллельно с уровнями HSK.
                        </div>

                        <div class="progress-container">
                            <div class="progress-header">
                                <span class="progress-label">Ваш прогресс</span>
                                <span class="progress-percent"><?php echo e($cProgress); ?>%</span>
                            </div>
                            <div class="progress-bar">
                                <div class="progress-fill" style="width: <?php echo e($cProgress); ?>%"></div>
                            </div>
                        </div>

                        <div class="hsk-stats">
                            <div class="stat">
                                <span class="stat-value"><?php echo e($cTotal); ?></span>
                                <span class="stat-label">Всего</span>
                            </div>
                            <div class="stat">
                                <span class="stat-value"><?php echo e($cLearned); ?></span>
                                <span class="stat-label">Выучено</span>
                            </div>
                            <div class="stat">
                                <span class="stat-value"><?php echo e($cRemaining); ?></span>
                                <span class="stat-label">Осталось</span>
                            </div>
                        </div>
            ...
            <div class="select-level-collections-footer">
                <a href="<?php echo e(route('collections.index')); ?>" class="select-level-collections-all-link">Все мои коллекции →</a>
            </div>
        </section>
...
<?php endif; ?><?php /**PATH /home/c/cy906984/kanjilflow_public/public_html/resources/views/user/learning/select-level.blade.php ENDPATH**/ ?>