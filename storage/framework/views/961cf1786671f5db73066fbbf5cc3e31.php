...
<section class="profile-section">
    ...
    <div
        ...
        data-update-url="<?php echo e(route('profile.two-factor.update')); ?>"
    >
        <div class="profile-2fa-status">
            <span class="profile-2fa-label">Статус:</span>
            <span id="profile-2fa-badge" class="profile-badge <?php echo e($twoFactorOn ? 'profile-badge--success' : 'profile-badge--muted'); ?>">
                <?php echo e($twoFactorOn ? 'Включена' : 'Отключена'); ?>
        ...
        <?php if(session('status') === 'two-factor-enabled' || session('status') === 'two-factor-disabled'): ?>
        ...
        <div id="profile-2fa-when-off" class="profile-2fa-actions <?php echo e($twoFactorOn ? 'profile-2fa--hidden' : ''); ?>">
        ...
        <div id="profile-2fa-when-on" class="profile-2fa-actions <?php echo e($twoFactorOn ? '' : 'profile-2fa--hidden'); ?>">
                    ...
                    <form id="profile-2fa-form-disable" class="profile-form-vertical" action="#" method="post">
                        ...
                        <div class="form-group profile-form-group">
                            ...
                            <input
                                ...
                                name="password"
                                type="password"
                                class="form-control <?php $__errorArgs = ['password', 'twoFactor'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__errorArgs = ['password', 'twoFactor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="profile-field-error profile-2fa-server-error"><?php echo e($message); ?></p>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php /**PATH /home/c/cy906984/kanjilflow_public/public_html/resources/views/profile/partials/two-factor-form.blade.php ENDPATH**/ ?>